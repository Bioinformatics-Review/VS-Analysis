...
This package provides top poses amongst the screened compounds with the lowest binding affinity.
...
This package also allows users to get binding affinities of compounds based on a user inputted cutoff value. The user can provide a threshold for binding affinities above which all affinities present in the files will be provided in an output file.
